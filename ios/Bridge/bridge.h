/*
 * The bridge APIs between the native code and the Node.js engine.
 * https://github.com/nodejs-mobile/nodejs-mobile-cordova/blob/unstable/src/common/cordova-bridge/cordova-bridge.h
 */

#ifndef CAPACITOR_NODEJS_BRIDGE_H
#define CAPACITOR_NODEJS_BRIDGE_H
...
#endif //CAPACITOR_NODEJS_BRIDGE_H
