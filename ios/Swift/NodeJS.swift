...
@objc public class NodeJS: NSObject, NodeProcessDelegate {
    ...
    private func findBuiltinModulesInBundle() -> String? {
        ...
        // Check SPM resource bundle (Bundle.module is generated by SPM for targets with resources)
        if let path = Bundle.module.path(forResource: "builtin_modules", ofType: nil) {
            return path
        }
